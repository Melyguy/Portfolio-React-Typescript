...
const mainText = "Games"
  ...
  return (
    <main className="text-fuchsia-600">
      <h1 className=" h-[20vh] mt-16 flex justify-center items-center text-[15vw] font-bold md:h-[45vh] md:flex md:justify-center md:items-center md:text-[15vw] md:font-bold ">{mainText}</h1>
