          ...
          <SmallCardDisplay imagesrc = {eren} />
            ...
            <div className="col-span-3 row-span-1 bg-neutral-100 rounded-xl p-4 ">
                <div className="grid grid-cols-3 grid-rows-1 gap-2">
                    ...
                    <h1 className=" text-4xl md:text-8xl font-bold bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-transparent bg-clip-text">∞+</h1>
                ...
                <div className="col-span-1 row-span-1 bg-neutral-300 rounded-3xl flex flex-col justify-center items-center ">
                <h1 className="text-4xl md:text-8xl font-bold bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-transparent bg-clip-text">00</h1>
                ...
                <div className="col-span-1 row-span-1 bg-neutral-300 rounded-3xl flex flex-col justify-center items-center ">
                <h1 className="text-4xl md:text-8xl font-bold bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-transparent bg-clip-text">06</h1>
