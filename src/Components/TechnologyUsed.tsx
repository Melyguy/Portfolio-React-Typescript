    ...
    return(
        <div className="col-span-1 row-span-5 bg-neutral-100 rounded-xl p-4">
                    ...
                    <div className="grid grid-cols-1 gap-2 p-2">
                        <div className="bg-neutral-300 text-blue-950 rounded-2xl md:py-1 md:px-2 text-xs font-semibold text-center flex items-center justify-center gap-1">
                        ...
                        <div className="bg-neutral-300 text-neutral-950 rounded-2xl md:py-1 md:px-2 text-xs font-semibold text-center flex items-center justify-center gap-1">
