...
export function SmallCardDisplay({imagesrc} : cardProps){
    return(
        <div className="col-span-1 row-span-2  p-2 rounded-xl cursor-pointer group perspective-1000 shadow-xl hidden md:flex">
